...
public class BookingService extends BaseEntityService<Booking> {
    ...
    public BookingService() {
        ...
        if(System.getenv("ORDERS-SERVICE") != null) {
            this.ordersServiceUri = "https://"+System.getenv("ORDERS-SERVICE")+".apps.pcfeu.dev.dynatracelabs.com/rest/bookings";
        } else {
            this.ordersServiceUri = "https://orders-service.apps.pcfeu.dev.dynatracelabs.com/rest/bookings";
        }
    }
