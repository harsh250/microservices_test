...
public class TeiidTestDataSources {
    ...
    public DataSource legacyDS() {
        ...
        DataSource dataSource = DataSourceBuilder.create().driverClassName("org.h2.Driver").username("").password("").url("jdbc:h2:mem:legacydb;DB_CLOSE_ON_EXIT=FALSE;DATABASE_TO_UPPER=FALSE;MODE=MYSQL").build();
    ...
    public DataSource ordersDS() {
        DataSource dataSource = DataSourceBuilder.create().driverClassName("org.h2.Driver").username("").password("").url("jdbc:h2:mem:ordersdb;DB_CLOSE_ON_EXIT=FALSE;DATABASE_TO_UPPER=FALSE;MODE=MYSQL").build();
